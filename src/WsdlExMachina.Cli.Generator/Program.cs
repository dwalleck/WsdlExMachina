...
namespace WsdlExMachina.Cli.Generator;
...
public static class Program
{
    public static int Main(string[] args)
    {
        ...
        {
            config.SetApplicationName("wsdl-generator");
            config.SetApplicationVersion("1.0.0");

            config.AddExample(new[] { "--wsdl", "path/to/service.wsdl", "--output", "Generated", "--namespace", "MyCompany.ServiceClient" });
        });
